...
INPUT_PATH = "task4_prompts_baseline.jsonl"
OUTPUT_DIR = Path("data")
TRAIN_PATH = OUTPUT_DIR / "task4_train.jsonl"
VAL_PATH = OUTPUT_DIR / "task4_val.jsonl"
...
print("Validation research questions:")
...
print("\nРаспределение query_id в train:")
print(Counter(item["query_id"] for item in train_items))
